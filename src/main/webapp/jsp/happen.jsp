        ...
        <div class="container-fluid am-cf">
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"> 地区人口</span>  </div>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body  widget-body-lg am-fr">
                            ...
                            am-table-striped am-table-centered am-text-nowrap am-text-middle" id="happenList">
                                <thead>
                                <tr>
                                    <th>地区</th>
                                    <th>年份</th>
    ...
    <div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt">
        <div class="am-modal-dialog">
            ...
            <div class="am-modal-bd">
                <form id="happen" class="am-form tpl-form-line-form">
                    ...
                    <div class="am-form-group">
                        <label for="population">年末常住人口：</label>
                        <input type="text" class="tpl-form-input" id="population" name="population" placeholder="请输入值"
                               required="required" style="width: 610px">
                    </div>

                    <div class="am-form-group">
                        <label for="birth">出生率：</label>
                        <input type="text" class="tpl-form-input" id="birth" name="birth" placeholder="请输入值"
                               required="required" style="width: 660px">
                    </div>

                    <div class="am-form-group">
                        <label for="death">死亡率：</label>
                        <input type="text" class="tpl-form-input" id="death" name="death" placeholder="请输入值"
                               required="required" style="width: 660px"/>
                    </div>

                    <div class="am-form-group">
                        <label for="growth">自然增长率：</label>
                        <input type="text" class="tpl-form-input" id="growth" name="growth" placeholder="请输入值"
                               required="required" style="width: 625px"/>
                    </div>
                    <button id="submit" class="am-btn am-btn-primary btn-loading-example" type="button" form="happen" value="确定">确定</button>
                    <button id="cancel" class="am-btn am-btn-primary btn-loading-example" type="button" form="happen" value="取消">取消</button>
                </form>
            </div>
        </div>
    </div>
